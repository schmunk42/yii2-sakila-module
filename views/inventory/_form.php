...
<div class="inventory-form">
    ...
    <?php $this->beginBlock('main'); ?>    		<?= '<label>film_id</label>'.\dosamigos\selectize\Selectize::widget([
    'model' => $model,
    'attribute' => 'film_id',
    'clientOptions' => [
        'delimiter' => ',',
    ...
    <?php $this->beginBlock('Rentals'); ?><h3><?= \yii\helpers\Html::a('Rentals', ['rental/index']) ?></h3><?php echo '' ?><?php $this->endBlock(); ?>
    <?=
